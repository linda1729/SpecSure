...
// --- Data ---
const features = [
  { id: '01', title: 'Spectral Analysis', subtitle: '400-1000nm Range', desc: 'Capturing the invisible. Our sensors decompose light into hundreds of bands, revealing chemical compositions instantly.', image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2000&auto=format&fit=crop' },
  { id: '02', title: 'Neural Networks', subtitle: 'SpecNet Architecture', desc: 'Proprietary lightweight models designed for edge devices. Real-time inference without cloud latency.', image: 'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?q=80&w=2000&auto=format&fit=crop' },
  { id: '03', title: 'Optic Hardware', subtitle: 'High-Fidelity', desc: 'Custom lens arrays engineered for maximum light throughput and minimal distortion.', image: 'https://images.unsplash.com/photo-1614728263952-84ea256f9679?q=80&w=2000&auto=format&fit=crop' },
];
...
const floatingItems = [
    { type: 'image', src: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=400&auto=format&fit=crop', x: '10%', y: '20%', rotate: -10, scale: 0.9 }, // Avatar 1
    { type: 'emoji', content: '🔮', x: '85%', y: '25%', rotate: 15, scale: 1.8 },
    { type: 'image', src: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=400&auto=format&fit=crop', x: '80%', y: '65%', rotate: 5, scale: 1 }, // Avatar 2
    { type: 'emoji', content: '⚡', x: '15%', y: '70%', rotate: -10, scale: 2.5 },
    { type: 'symbol', content: 'view_in_ar', x: '80%', y: '15%', rotate: -8, scale: 1.2 }, // 3D Icon
    { type: 'symbol', content: 'code_blocks', x: '5%', y: '45%', rotate: 20, scale: 1.4 }  // Tech Icon
];
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`w-full md:w-1/2 flex flex-col justify-center text-center mb-12 md:mb-0 ${textAlignClass}`}>
                                <FadeIn>
                                    <h3 className="text-5xl md:text-7xl font-serif mb-4">{member.name}</h3>
    ...
    <div className="bg-white text-black min-h-screen selection:bg-black selection:text-white overflow-x-hidden">
      ...
      <section className="min-h-[95vh] relative flex flex-col justify-center items-center px-6 md:px-12 pt-32 pb-12 border-b border-black/10 overflow-hidden">
         ...
         <div className="relative z-10 text-center max-w-4xl mx-auto">
             ...
             >
                 ...
                 <span className="font-code text-xs uppercase tracking-widest text-gray-500">Vol. 1 — 2025</span>
                 <span className="h-[1px] w-12 bg-black"></span>
             </motion.div>
             ...
             <motion.h1 
                ...
                className="font-huge leading-[0.85] tracking-tight mb-8 flex flex-col items-center"
             >
                 <span>SpecSure</span>
                 <span className="font-cn text-[42px] md:text-[60px] mt-6 opacity-80 font-normal tracking-[0.2em]">澜瞳</span>
             </motion.h1>
      ...
      <section className="border-b border-black/10">
          <div className="flex flex-col md:flex-row">
              {/* Sticky Left Column */}
              <div className="md:w-[40%] md:h-screen sticky top-0 flex flex-col justify-center p-6 md:p-16 bg-white z-10 border-r border-black/10">
                  <FadeIn>
                      <span className="font-code text-xs uppercase tracking-widest text-gray-400 mb-4 block">Our Expertise</span>
                      <h2 className="text-5xl md:text-7xl font-serif leading-none mb-8">
                          Core<br/>Capabilities
                      </h2>
                      <p className="text-lg text-gray-500 font-sans max-w-sm">
                          Integrating hardware precision with software intelligence to see what others miss.
                      </p>
                  </FadeIn>
              </div>
